...
def createFile(text):
	appLocation = "C:\\Users\\jainul\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
	
	if isContain(text, ["ppt","power point","powerpoint"]):
		file_name = "sample_file.ppt"
		appLocation = "C:\\Program Files (x86)\\Microsoft Office\\Office12\\POWERPNT.EXE"

	elif isContain(text, ['excel','spreadsheet']):
		file_name = "sample_file.xsl"
		appLocation = "C:\\Program Files (x86)\\Microsoft Office\\Office12\\EXCEL.EXE"

	elif isContain(text, ['word','document']):
		file_name = "sample_file.docx"
		appLocation = "C:\\Program Files (x86)\\Microsoft Office\\Office12\\WINWORD.EXE"
